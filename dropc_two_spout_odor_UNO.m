    ...
    while (stopTrials==0)&(handles.dropcData.trialIndex<200)
        ...
        while (resultOfTrial == -2)
            ...
            if (dropcFinalValveOK_two_spout(handles)==1)
                ...
                if handles.dropcProg.useUNO==0
                    [trialResult, left_right]=dropcDoesMouseRespondNow_two_spout(handles);
                else
                    [trialResult,left_right]=dropcDoesMouseRespondNow_two_spoutUNO(handles);
                end
                ...
                if (trialResult~=2)
                    ...
                    if trialResult==1
                        ...
                        disp(['Mouse did not lick = ' num2str(trialResult)])
                    end
