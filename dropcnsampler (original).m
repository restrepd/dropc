...
handles.dropcProg.output_file='C:\Users\Behavior\Desktop\Alexia_NP\test_nsamplerm';
    ...
    if change_odor_in_each_trial==0
        ...
        for odorNo=1:handles.dropcProg.noOdors
            ...
            for trialNo=1:handles.dropcProg.trialsPerOdor
                ...
                start_toc=toc;
                while (toc-start_toc<handles.dropcProg.odor_time-0.4)
                end
                %end
        ...
        for trialNo=1:handles.dropcProg.trialsPerOdor*handles.dropcProg.noOdors
            for odorNo=1:handles.dropcProg.noOdors
                ...
                %if handles.dropcProg.skipIntervals==0
                start_toc=toc;
                while (toc-start_toc<(handles.dropcProg.dt_between_trials-handles.dropcProg.timePerTrial))
                end
                %end
