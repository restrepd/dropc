...
handles.dropcProg.output_file='C:\Users\Mini Fabio\Desktop\DEMJ3\82021312588isominrigth.mat';
...
handles.dropcProg.reward_location_vs_odor=2; %0=reward for licks regardless of location (begin), 1=reward for odor, 2=reward for location
...
handles.dropcProg.rewardedOdorValveLeft=uint8(16); %Make sure to use int8
handles.dropcProg.rewardedOdorNameLeft='Isoamyl acetate';

handles.dropcProg.otherOdorValveLeft=uint8(32); %Make sure to use int8
handles.dropcProg.otherOdorNameLeft='Mineral oil';

%Enter right valves (8,16,32) and odor name
handles.dropcProg.rewardedOdorValveRight=uint8(2); %Make sure to use int8
handles.dropcProg.rewardedOdorNameRight='Isoamyl acetate';

handles.dropcProg.otherOdorValveRight=uint8(1); %Make sure to use int8
