function handles = dropcStageTwoAud(handles)
...
while handles.dropcData.trialIndex<160
    ...
    while (resultOfTrial == -2)
        ...
        if (dropcFinalValveOKAudBegin(handles)==1)
            ...
            if (trialResult~=2)
                ...
                start_toc=toc;
                while toc-start_toc<handles.dropcProg.noRAsegments*handles.dropcProg.dt_ra
                end
