...
handles.dropcProg.output_file='C:\Users\Mini Fabio\Documents\Fabio_olfatometro_2021\Data\20230421_FCM16_miniscope_spm_leftright_4';
...
%1=reward for licks regardless of location (go-no go begin),
...
handles.dropcProg.rewardedOdorValveRight=uint8(16); %Make sure to use int8
handles.dropcProg.rewardedOdorNameRight='ISO';

handles.dropcProg.otherOdorValveRight=uint8(8); %Make sure to use int8
handles.dropcProg.otherOdorNameRight='Acetophe';
...
handles.dropcProg.rewardedOdorNameLeft='ISO';

handles.dropcProg.otherOdorValveLeft=uint8(1); %Make sure to use int8
handles.dropcProg.otherOdorNameLeft='Acetophe';
...
handles.dropcProg.rfTime_left=0.15; %0.2
handles.dropcProg.rfTime_right=0.15; %0.2
...
%seconds here.
handles.dropcProg.dt_punish=10; %30;

handles.dropcProg.dt_iti= 8; %15;
