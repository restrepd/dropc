...
%Enter punish valve with 1% ammonia (1,2,4,8,16,32,64,128)
handles.dropcProg.purgeValve=uint8(32); %Make sure to use int8
handles.dropcProg.purgeName='Ammonia';
...
%Time to turn on the ammonia
handles.dropcProg.dt_punish=1;
