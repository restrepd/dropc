function handles=dropcReinforceAppropriately_hf_eng(handles)
%Turns all valves off

do_dt_punish=0;

if (handles.dropcProg.typeOfOdor==handles.dropcProg.splusOdor1)|(handles.dropcProg.typeOfOdor==handles.dropcProg.splusOdor2)
    %S+
